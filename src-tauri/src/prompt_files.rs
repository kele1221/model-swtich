...
use crate::config::{get_claude_cn_settings_path, get_claude_settings_path};
...
pub fn prompt_file_path(app: &AppType) -> Result<PathBuf, AppError> {
    ...
    let base_dir: PathBuf = match app {
        ...
        AppType::ClaudeCn => {
            get_base_dir_with_fallback(get_claude_cn_settings_path(), ".claude-cn")?
        }
    ...
    let filename = match app {
        AppType::Claude | AppType::ClaudeCn => "CLAUDE.md",
