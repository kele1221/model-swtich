//! Deep link import functionality for Model-Switch
//!
//! This module implements the modelswitch:// protocol for importing configurations
...
///
/// Represents a parsed modelswitch:// URL ready for processing.
