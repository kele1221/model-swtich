...
//!
//! Parses modelswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a modelswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// modelswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "modelswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'modelswitch', got '{scheme}'"
        )));
    }
